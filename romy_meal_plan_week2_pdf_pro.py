#!/usr/bin/env python3
"""
Romy's Week 2 Meal Plan (PRO Layout, 1400 kcal)
"""
import os
...
from romy_meal_plan_week2_pdf import get_meal_plan_text as romy_text
...
def create_pdf():
    ...
    filename = os.path.join(
        OUTPUT_DIR, f"Romy_Week2_Meal_Plan_{current_date}_PRO.pdf")
    ...
    <b>Goal:</b> Plant-Based Weight Loss (1400 kcal)
    </para>
    """, info_style))
    ...
    doc.build(story)
    print(f"✅ Romy Week 2 PRO PDF created: {filename}")
