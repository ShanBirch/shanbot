...
def create_meal_plan_pdf(meal_plan_text, client_data, nutrition_data):
    """Create PDF for Marc's meal plan - matching original styling"""
    ...
    try:
        ...
        # Add nutrition info style
        nutrition_info_style = ParagraphStyle(
            'NutritionInfo',
            parent=styles['Normal'],
            fontSize=11,
            spaceBefore=20,
        ...
        if shopping_list_content:
            ...
            for line in shopping_list_content:
                ...
                if line.endswith(':') and not line.startswith('-') and not line.startswith('•'):
                    ...
                    # This is an item
                    # Remove the dash, asterisk, or bullet point
                    item_text = line[1:].strip()
                    if item_text:
                        # Format as clickable link with proper URL encoding
                        # Use a single underline tag to prevent breaks
        ...
        1. <b>Use Protein Isolates:</b> Plant-based protein powders (pea, rice, hemp) provide concentrated protein without the accompanying carbs or fats
        2. <b>Choose High-Protein Versions:</b> Opt for products like Vetta Protein Pasta (24.9g protein/100g) instead of regular pasta
        3. <b>Strategic Food Combining:</b> Pair incomplete proteins throughout the day to create complete amino acid profiles
        4. <b>Focus on Protein-Dense Whole Foods:</b> Tofu, tempeh, seitan, and TVP provide more protein per calorie<br/><br/>
        ...
        story.append(Paragraph(nutrition_guide, nutrition_info_style))
...
async def main():
    ...
    print(f"=== MARC'S NUTRITION TARGETS ===")
